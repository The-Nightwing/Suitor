  ...
  if (typeof define === function && define.amd) {
    ...
    module.exports = function (root, jQuery) {
      if (jQuery === undefined) {
        ...
        // if its defined (how jquery works)
    ...
    function normalize(name, baseName) {
        ...
        if (name && name.charAt(0) === ".") {
            ...
            if (baseName) {
                ...
                //"directory" and not name of the baseNames module. For instance,
...
S2.define(select2/utils,[
  ...
  Utils.Decorate = function (SuperClass, DecoratorClass) {
    ...
    var calledMethod = function (methodName) {
      // Stub out the original method if its not decorating an actual method
  ...
  Utils.escapeMarkup = function (markup) {
    ...
    // Do not try to escape the markup if its not a string
...
>>>>>>> 05a93769e96641c3a5054a7fe51edb64c1cdfd30
    ...
    container.on(results:previous, function () {
      ...
      // If we are already at te top, dont move further
      if (currentIndex === 0) {
        return;
      }
...
S2.define(select2/selection/allowClear,[
  ...
  AllowClear.prototype._handleClear = function (_, evt) {
    ...
    for (var d = 0; d < data.length; d++) {
      ...
      // If the event was prevented, dont clear it out.
...
S2.define(select2/selection/search,[
  ...
  Search.prototype.bind = function (decorated, container, $container) {
    ...
    // This property is not available in Edge, but Edge also doesnt have
    // this bug.
...
S2.define(select2/data/select,[
  ...
  SelectAdapter.prototype.option = function (data) {
    ...
    // Override the options data with the combined data
...
S2.define(select2/data/tokenizer,[
  ...
  Tokenizer.prototype.query = function (decorated, params, callback) {
    ...
    function createAndSelect (data) {
      ...
      // Select it if it doesnt
      var $existingOptions = self.$element.find(option).filter(function () {
        return $(this).val() === item.id;
      });

      // If an existing option wasnt found for it, create the option
...
S2.define(select2/dropdown/selectOnClose,[
  ...
  SelectOnClose.prototype._handleSelectOnClose = function (_, params) {
    if (params && params.originalSelect2Event != null) {
      ...
      // Dont select an item if the close event was triggered from a select or
      // unselect event
    ...
    // Dont re-select already selected resulte
    if (
...
S2.define(select2/dropdown/closeOnSelect,[
  ...
  CloseOnSelect.prototype._selectTriggered = function (_, evt) {
    ...
    // Dont close if the control key is being held
    ...
    if ($.isArray(options.language)) {
      ...
      for (var l = 0; l < languageNames.length; l++) {
        ...
        try {
          ...
          try {
            // If we couldnt load it, check if it wasnt the full path
    ...
    function matcher (params, data) {
      ...
      if (data.children && data.children.length > 0) {
        ...
        for (var c = data.children.length - 1; c >= 0; c--) {
          ...
          // If there wasnt a match, remove the object in the array
          if (matches == null) {
      ...
      // If it doesnt contain the term, dont return anything
      return null;
    }
...
S2.define(select2/options,[
  ...
  Options.prototype.fromElement = function ($e) {
    ...
    // Prefer the elements dataset attribute if it exists
...
>>>>>>> 05a93769e96641c3a5054a7fe51edb64c1cdfd30
    ...
    if (!mutations) {
      // If mutation events arent supported, then we can only assume that the
    ...
    function wrappedMatcher (params, data) {
      ...
      if (data.children) {
        for (var c = data.children.length - 1; c >= 0; c--) {
          ...
          // If the child didnt match, pop it off
          if (!doesMatch) {
            match.children.splice(c, 1);
          }
        }
...
(function (factory) {
    ...
    function handler(event) {
        ...
        // Need to convert lines and pages to pixels if we arent already in pixels
...
S2.define(jquery.select2,[
  ...
  // We know that all of the modules exist above this, so were safe
