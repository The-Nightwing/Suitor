...
| **Variable** | **Datatype** | **Integrity Constraints** |
| --- | --- | --- |
| userID | char(10) | Not null, Foreign key, part of Primary key along with caseID, whentttt |
| caseID | char(15) | Not null, Foreign key, part of Primary key along with userID, whentttt |
| whentttt | datetime | Not null, Foreign key, part of Primary key along with userID, caseID |
...
| --- | --- | --- |
| userID | char(10) | Primary Key |
| whentttt | datetime | Not null, part of Primary Key along with calendarID |
...
| DisplayedIn | caseID, whentttt, userID |
